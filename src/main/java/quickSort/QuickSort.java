...
/**
 * Created by VKurochkin on 3/10/2017.
 */
public class QuickSort {
    ...
    public static void quickSort(int[] inputArray, int start, int end){
        if(start < end){
            ...
            quickSort(inputArray, pp+1, end); /// sorts the left half of the range
        }
    }
    ...
    public static int partition(int[] inputArray, int start, int end){
        ...
        inputArray[end] = ival;
        inputArray[i+1] = pivot; // pivot value placed in the correct position
